...
- 在element/iview/vuetify/ant design里都有叫select的下拉框  
- vuetify有一种下拉框叫combobox的下拉框  
  ant design里有一种叫dropdown的下拉框
- select在百度和谷歌翻译里都没有下拉框的意思  
  甚至不具有名词词性



[各种弹出层](https://devework.com/difference-among-dialog-modal-popup-popover-lightbox.html)
...
- prompt  
  [java官网](https://dev.java/learn/getting-started-with-java/#anchor_6)就用prompt
- terminal  
  GUI工具上一般用terminal表示终端
- console  
  有的文章会用console来表示终端



原生语言<span style='opacity:.5'>（不带任何库或框架的）</span>

vanilla  

比如Vanilla Java和vanilla js
...
[vue官网](https://cn.vuejs.org/v2/guide/list.html#%E5%9C%A8-v-for-%E9%87%8C%E4%BD%BF%E7%94%A8%E5%AF%B9%E8%B1%A1)用property来表示对象的正常属性



文件后缀名

正确写法：file extension或filename extension  
suffix name是不正确的
