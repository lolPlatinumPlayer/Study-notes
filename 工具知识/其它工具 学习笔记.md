...
- 新增几何图形  
  ...
  4. 可通过[![vertexTool](https://docs.qgis.org/3.16/en/_images/mActionVertexTool.png)顶点工具](https://docs.qgis.org/3.16/en/docs/user_manual/working_with_vector/editing_geometry_attributes.html#vertex-tool)编辑几何形状
  5. 可在左下角Layers面板上右键图层来做更多设置
