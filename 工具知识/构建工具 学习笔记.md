...
[yarn2官网](https://yarnpkg.com/getting-started/install)

官网里提到的`npm install -g yarn`装的实际上是1.x版本的  
似乎要到项目文件夹下执行`yarn set version berry`才可以在项目里用2.x的yarn
...
[yarn1官网](https://classic.yarnpkg.com/en/docs/install#windows-stable)
...
- demo  
  ...
  - webpack配置  
    ...
    其中`title`源自[这里（官方github）](https://github.com/jantimon/html-webpack-plugin#options)
